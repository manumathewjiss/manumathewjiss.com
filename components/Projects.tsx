            ...
            >
              ...
              {project.demo && (
                <a
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-3 py-2.5 text-xs font-bold text-black shadow-md shadow-accent/20 hover:brightness-110 transition-all mb-2"
                  aria-label={project.demoLabel ?? "Open project"}
                >
                  {project.demoLabel ?? "Open link"}
              ...
              {/* Secondary: GitHub (when demo exists, show outlined link too) */}
              {project.demo && project.github && (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={(e) => e.stopPropagation()}
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-border-subtle px-3 py-2 text-xs font-medium text-text-secondary hover:border-accent/40 hover:text-accent transition-colors mb-3"
              ...
              {!project.demo && project.github && (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={(e) => e.stopPropagation()}
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-3 py-2.5 text-xs font-bold text-black mb-3"
                  aria-label="GitHub repository"
                >
                  View on GitHub
                  <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24">
