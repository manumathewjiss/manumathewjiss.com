                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {project.demo && (
                    <a
                      ...
                      className="text-text-muted hover:text-accent transition-colors text-[10px] font-medium whitespace-nowrap"
                      aria-label={project.demoLabel ?? "Visit project"}
                    >
                      {project.demoLabel ?? "Link"}
                      <svg className="inline w-3 h-3 ml-0.5 -mt-px align-middle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
